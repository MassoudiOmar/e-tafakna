...
////yahbenniiiiiiiiiiiiii
let getAllContracts = (req, res) => {
 const {id}=req.params

  const sql = `select uo.username,ur.username,c.created_at,c.contract_url,ct.signed_time,ct.title_FR,c.status,ct.image_url  from users_has_contracts  uhc
...
module.exports = { userContract, getOwner,getAllContracts };
