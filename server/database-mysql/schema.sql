...
(
  ...
  (
    "Indiquer la fonction dans l'entreprise",
    "null",
  ...
  (
    "Quel est l'object de votre demande",
    "null",
  ...
  (
    "Veuillez presier votre demande",
    "null",
...
(
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457759/unnamed_1_1_lzrkcv.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "شهادة تدريب",
    "Au sens le plus large, une attestation de formation est un document attestant que le titulaire a suivi une formation spécifique",
    "desc_AR",
    ...
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457759/unnamed_3_1_bumvz0.png",
    "https://res.cloudinary.com/e-tafakna/raw/upload/v1664543960/Attestation-de-stage_n2_rjvm0l.docx",
    "https://res.cloudinary.com/dew6e8h2m/raw/upload/v1665051324/Attestation-de-stage_en1_sxoacs.docx",
    "https://res.cloudinary.com/dew6e8h2m/raw/upload/v1665051324/Attestation-de-stage_en1_sxoacs.docx",
    "Tunisia"
  ),
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457758/unnamed_4_1_fzraz8.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    5,
    "Microcredit",
    "Contrat de Prêt numéraire (microcrédit) ",
    "قرض",
    "This is loan Description",
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457758/unnamed_5_1_exbhco.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457758/unnamed_6_1_owmpwk.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457758/unnamed_7_1_evodld.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_10_1_wbb9lm.png",
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457758/unnamed_9_1_pmtbst.png",
    "https://res.cloudinary.com/e-tafakna/raw/upload/v1664562844/Engagement_contract_n2_x14mz3.docx",
    "https://res.cloudinary.com/e-tafakna/raw/upload/v1664562844/Engagement_contract_n2_x14mz3.docx",
    "https://res.cloudinary.com/e-tafakna/raw/upload/v1664562844/Engagement_contract_n2_x14mz3.docx",
    "Tunisia"
  ),
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_18_1_fssujl.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_13_1_klfbym.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_12_1_mol4hi.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    5,
    "Idea registration",
    "Enregistrement d'une idée",
    "Enregistrement d'une idée",
    "This is Employment Contract Description",
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_11_1_rkyp58.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_15_1_ubzxye.png",
    "temp_FR",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ...
  (
    ...
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_17_1_mejvek.png",
    "https://res.cloudinary.com/dew6e8h2m/raw/upload/v1664625501/Attestation_de_Domiciliation_n2_anigf5.docx",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  ),
  (
    ...
    "Demande officielle",
    "طلب رسمي",
    "This is demande  Description",
    "desc_AR",
    "desc_EN",
    "https://res.cloudinary.com/dfctzd9p3/image/upload/v1664457757/unnamed_17_1_mejvek.png",
    "https://res.cloudinary.com/e-tafakna/raw/upload/v1664546377/Demande_officielle_n4_m4cbe4.docx",
    "temp_AR",
    "temp_EN",
    "Tunisia"
  );
